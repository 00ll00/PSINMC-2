...
scoreboard players operation #math.mat.det.temp PS.mem /= $1000 PS.const
scoreboard players operation $math.mat.adj.3.3 PS.mem -= #math.mat.det.temp PS.mem
tellraw @a [{"score": {"name": "$math.mat.a.1.1","objective": "PS.mem"}}," ",{"score": {"name": "$math.mat.a.1.2","objective": "PS.mem"}}," ",{"score": {"name": "$math.mat.a.1.3","objective": "PS.mem"}}]
tellraw @a [{"score": {"name": "$math.mat.a.2.1","objective": "PS.mem"}}," ",{"score": {"name": "$math.mat.a.2.2","objective": "PS.mem"}}," ",{"score": {"name": "$math.mat.a.2.3","objective": "PS.mem"}}]
tellraw @a [{"score": {"name": "$math.mat.a.3.1","objective": "PS.mem"}}," ",{"score": {"name": "$math.mat.a.3.2","objective": "PS.mem"}}," ",{"score": {"name": "$math.mat.a.3.3","objective": "PS.mem"}}]
tellraw @a ""
tellraw @a [{"score": {"name": "$math.mat.adj.1.1","objective": "PS.mem"}}," ",{"score": {"name": "$math.mat.adj.1.2","objective": "PS.mem"}}," ",{"score": {"name": "$math.mat.adj.1.3","objective": "PS.mem"}}]
tellraw @a [{"score": {"name": "$math.mat.adj.2.1","objective": "PS.mem"}}," ",{"score": {"name": "$math.mat.adj.2.2","objective": "PS.mem"}}," ",{"score": {"name": "$math.mat.adj.2.3","objective": "PS.mem"}}]
tellraw @a [{"score": {"name": "$math.mat.adj.3.1","objective": "PS.mem"}}," ",{"score": {"name": "$math.mat.adj.3.2","objective": "PS.mem"}}," ",{"score": {"name": "$math.mat.adj.3.3","objective": "PS.mem"}}]
