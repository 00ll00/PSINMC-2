#as stroke
execute align xyz run summon minecraft:area_effect_cloud ~.5 ~ ~.5 {Tags:["PS.color.raw","PS.color.raw.new","PS.color.raw_"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
