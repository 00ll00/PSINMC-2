...
scoreboard players operation #color.mix PS.color.r *= $color.a PS.mem
scoreboard players operation #color.mix PS.color.g *= $color.a PS.mem
scoreboard players operation #color.mix PS.color.b *= $color.a PS.mem
scoreboard players operation #color.mix PS.color.a = $color.a PS.mem
