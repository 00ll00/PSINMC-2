...
function ps:path/anchor/gen/getleft
...
scoreboard players add #path.anchor.genid PS.mem 1
execute as @e[tag=PS.path.a,tag=PS.path.working] if score @s PS.path.a.id = #path.anchor.genid PS.mem run function ps:path/anchor/gen/getright
...
function ps:path/anchor/gen/recu