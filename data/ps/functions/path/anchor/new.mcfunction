...
summon armor_stand ~ ~ ~ {Tags:["PS.","PS.path.a_","PS.path","PS.path.working","PS.focus.target","PS.path.a","PS.path.p"],Pose:{RightArm:[-15f,225f,0f]},Marker:1b,Invisible:1b,Small:1b,Glowing:1b}
