#as marker at marker
execute if score $focus.f PS.mem matches 5 run tp ~ ~ ~.9999

scoreboard players operation #focus.temp PS.mem = $focus.sz PS.mem
execute if score $focus.f PS.mem matches 5 run scoreboard players add #focus.temp PS.mem 1
scoreboard players operation #focus.temp PS.mem *= $focus.block.const2 PS.const
scoreboard players operation #focus.temp PS.mem -= #focus.bz PS.mem
scoreboard players operation #focus.temp PS.mem /= #focus.dz PS.mem
