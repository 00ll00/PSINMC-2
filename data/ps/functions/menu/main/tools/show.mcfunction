summon armor_stand ~ ~ ~ {"CustomName":'{"translate": "ps.menu.main.tools", "bold": true}',"CustomNameVisible":true,Invisible:true,Marker:true,Tags:["PS.","PS.menu", "PS.menu_", "PS.menu.focusable", "PS.players.owned", "PS.menu.main.tools", "PS.menu.event.mmi"],ArmorItems:[{id:"minecraft:stone","Count":1b,"tag":{"path": ".main.tools", "type": "item", "text": "{\"translate\": \"ps.menu.main.tools\", \"bold\": true}"}},{},{},{}]}
