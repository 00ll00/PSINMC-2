summon armor_stand ~ ~ ~ {"CustomName":'{"translate": "ps.tools.convertap", "bold": true, "color": "green"}',"CustomNameVisible":true,Invisible:true,Marker:true,Tags:["PS.menu", "PS.menu_", "PS.menu.focusable", "PS.players.owned", "PS.menu.main.tools_v.convertap", "PS.menu.event.exit", "PS.menu.end"],ArmorItems:[{id:"minecraft:stone","Count":1b,"tag":{"path": ".main.tools_v.convertap", "type": "item", "text": "{\"translate\": \"ps.tools.convertap\", \"bold\": true, \"color\": \"green\"}"}},{},{},{}]}
