summon armor_stand ~ ~ ~ {"CustomName":'{"translate": "ps.tools.anchor", "bold": true, "color": "green"}',"CustomNameVisible":true,Invisible:true,Marker:true,Tags:["PS.","PS.menu", "PS.menu_", "PS.menu.focusable", "PS.players.owned", "PS.menu.main.tools_v.anchor", "PS.menu.event.exit", "PS.menu.end"],ArmorItems:[{id:"minecraft:stone","Count":1b,"tag":{"path": ".main.tools_v.anchor", "type": "item", "text": "{\"translate\": \"ps.tools.anchor\", \"bold\": true, \"color\": \"green\"}"}},{},{},{}]}
