summon armor_stand ~ ~ ~ {"CustomName":'{"translate": "ps.menu.main.world", "bold": true}',"CustomNameVisible":true,Invisible:true,Marker:true,Tags:["PS.menu", "PS.menu_", "PS.menu.focusable", "PS.players.owned", "PS.menu.main.world", "PS.menu.event.mmi"],ArmorItems:[{id:"minecraft:stone","Count":1b,"tag":{"path": ".main.world", "type": "item", "text": "{\"translate\": \"ps.menu.main.world\", \"bold\": true}"}},{},{},{}]}
