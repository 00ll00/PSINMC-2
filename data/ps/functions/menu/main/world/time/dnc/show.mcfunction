summon armor_stand ~ ~ ~ {"CustomName":'{"translate": "ps.menu.main.world.time.dnc", "bold": true}',"CustomNameVisible":true,Invisible:true,Marker:true,Tags:["PS.","PS.menu", "PS.menu_", "PS.menu.focusable", "PS.players.owned", "PS.menu.main.world.time.dnc", "PS.menu.event.mmi"],ArmorItems:[{id:"minecraft:stone","Count":1b,"tag":{"path": ".main.world.time.dnc", "type": "item", "text": "{\"translate\": \"ps.menu.main.world.time.dnc\", \"bold\": true}"}},{},{},{}]}
