summon armor_stand ~ ~ ~ {"CustomName":'{"translate": "ps.menu.main.world.weather.dwc.true", "bold": true, "color": "green"}',"CustomNameVisible":true,Invisible:true,Marker:true,Tags:["PS.","PS.menu", "PS.menu_", "PS.menu.focusable", "PS.players.owned", "PS.menu.main.world.weather.dwc.true", "PS.menu.event.exit", "PS.menu.end"],ArmorItems:[{id:"minecraft:stone","Count":1b,"tag":{"path": ".main.world.weather.dwc.true", "type": "item", "text": "{\"translate\": \"ps.menu.main.world.weather.dwc.true\", \"bold\": true, \"color\": \"green\"}"}},{},{},{}]}
