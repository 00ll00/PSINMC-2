summon armor_stand ~ ~ ~ {"CustomName":'{"translate": "ps.tools.eraser3d", "bold": true, "color": "blue"}',"CustomNameVisible":true,Invisible:true,Marker:true,Tags:["PS.menu", "PS.menu_", "PS.menu.focusable", "PS.players.owned", "PS.menu.main.tools_3d.eraser3d", "PS.menu.event.exit", "PS.menu.end"],ArmorItems:[{id:"minecraft:stone","Count":1b,"tag":{"path": ".main.tools_3d.eraser3d", "type": "item", "text": "{\"translate\": \"ps.tools.eraser3d\", \"bold\": true, \"color\": \"blue\"}"}},{},{},{}]}
