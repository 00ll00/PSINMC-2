summon armor_stand ~ ~ ~ {"CustomName":'{"translate": "ps.menu.main.tools_adv", "bold": true}',"CustomNameVisible":true,Invisible:true,Marker:true,Tags:["PS.menu", "PS.menu_", "PS.menu.focusable", "PS.players.owned", "PS.menu.main.tools_adv", "PS.menu.event.mmi"],ArmorItems:[{id:"minecraft:stone","Count":1b,"tag":{"path": ".main.tools_adv", "type": "item", "text": "{\"translate\": \"ps.menu.main.tools_adv\", \"bold\": true}"}},{},{},{}]}
