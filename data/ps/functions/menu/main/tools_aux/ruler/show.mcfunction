summon armor_stand ~ ~ ~ {"CustomName":'{"translate": "ps.tools.ruler", "bold": true, "color": "light_purple"}',"CustomNameVisible":true,Invisible:true,Marker:true,Tags:["PS.","PS.menu", "PS.menu_", "PS.menu.focusable", "PS.players.owned", "PS.menu.main.tools_aux.ruler", "PS.menu.event.exit", "PS.menu.end"],ArmorItems:[{id:"minecraft:stone","Count":1b,"tag":{"path": ".main.tools_aux.ruler", "type": "item", "text": "{\"translate\": \"ps.tools.ruler\", \"bold\": true, \"color\": \"light_purple\"}"}},{},{},{}]}
