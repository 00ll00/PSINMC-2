...
execute if score $menu.tag.len PS.mem matches 20 run function ps:menu/events/exit/len/20
execute if score $menu.tag.len PS.mem matches 16 run function ps:menu/events/exit/len/16
...
execute if score $menu.tag.len PS.mem matches 24 run function ps:menu/events/exit/len/24
execute if score $menu.tag.len PS.mem matches 27 run function ps:menu/events/exit/len/27
execute if score $menu.tag.len PS.mem matches 11 run function ps:menu/events/exit/len/11
execute if score $menu.tag.len PS.mem matches 15 run function ps:menu/events/exit/len/15
execute if score $menu.tag.len PS.mem matches 13 run function ps:menu/events/exit/len/13
