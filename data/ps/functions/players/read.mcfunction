...
scoreboard players operation $tools.rev PS.mem = @s PS.tools.rev
...
data modify storage ps:players storage.data set from entity @e[tag=PS.players.belonging,tag=PS.players.data,limit=1] data
