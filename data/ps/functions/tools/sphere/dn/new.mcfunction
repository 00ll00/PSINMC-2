...
data modify storage ps:players storage.data.tools.sphere.state set value "hd_s"

data modify storage ps:players storage.data.tools.sphere.showr set value 1
data modify storage ps:players storage.data.tools.sphere.postype set value 2
scoreboard players set $players.actionbar.showr PS.mem 1
