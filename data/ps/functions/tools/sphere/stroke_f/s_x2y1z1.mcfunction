...
scoreboard players remove #tools.sphere.p.x PS.mem 1000
scoreboard players add #tools.sphere.p.y PS.mem 1000
scoreboard players add #tools.sphere.p.z PS.mem 1000
