#as stroke at @s
execute if blocks ~ ~ ~ ~ ~ ~ ~1 ~ ~ all positioned ~1 ~ ~ align xyz unless entity @e[tag=PS.tools.fill.stroke,dx=0,dy=0,dz=0] run summon minecraft:marker ~.5 ~.5 ~.5 {Tags: ["PS.tools.fill.stroke","PS.tools.fill.stroke_","PS.players.owned","PS.players.belonging"]}
execute if blocks ~ ~ ~ ~ ~ ~ ~-1 ~ ~ all positioned ~-1 ~ ~ align xyz unless entity @e[tag=PS.tools.fill.stroke,dx=0,dy=0,dz=0] run summon minecraft:marker ~.5 ~.5 ~.5 {Tags: ["PS.tools.fill.stroke","PS.tools.fill.stroke_","PS.players.owned","PS.players.belonging"]}
execute if blocks ~ ~ ~ ~ ~ ~ ~ ~1 ~ all positioned ~ ~1 ~ align xyz unless entity @e[tag=PS.tools.fill.stroke,dx=0,dy=0,dz=0] run summon minecraft:marker ~.5 ~.5 ~.5 {Tags: ["PS.tools.fill.stroke","PS.tools.fill.stroke_","PS.players.owned","PS.players.belonging"]}
execute if blocks ~ ~ ~ ~ ~ ~ ~ ~-1 ~ all positioned ~ ~-1 ~ align xyz unless entity @e[tag=PS.tools.fill.stroke,dx=0,dy=0,dz=0] run summon minecraft:marker ~.5 ~.5 ~.5 {Tags: ["PS.tools.fill.stroke","PS.tools.fill.stroke_","PS.players.owned","PS.players.belonging"]}
execute if blocks ~ ~ ~ ~ ~ ~ ~ ~ ~1 all positioned ~ ~ ~1 align xyz unless entity @e[tag=PS.tools.fill.stroke,dx=0,dy=0,dz=0] run summon minecraft:marker ~.5 ~.5 ~.5 {Tags: ["PS.tools.fill.stroke","PS.tools.fill.stroke_","PS.players.owned","PS.players.belonging"]}
