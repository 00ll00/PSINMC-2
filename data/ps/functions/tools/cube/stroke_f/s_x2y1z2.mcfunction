...
scoreboard players remove #tools.cube.p.x PS.mem 1000
scoreboard players add #tools.cube.p.y PS.mem 1000
scoreboard players remove #tools.cube.p.z PS.mem 1000
