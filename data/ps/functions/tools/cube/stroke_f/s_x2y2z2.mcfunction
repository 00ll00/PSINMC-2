...
scoreboard players remove #tools.cube.p.y PS.mem 1
scoreboard players remove #tools.cube.p.z PS.mem 1
...
scoreboard players operation $math.mat.b.1.1 PS.mem *= $1000 PS.const
scoreboard players operation $math.mat.b.2.1 PS.mem *= $1000 PS.const
scoreboard players operation $math.mat.b.3.1 PS.mem *= $1000 PS.const
