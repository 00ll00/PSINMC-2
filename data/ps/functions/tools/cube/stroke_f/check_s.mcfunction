...
execute store success score #cube.temp.reg PS.mem if score #cube.temp.reg.x PS.mem matches 1 if score #cube.temp.reg.y PS.mem matches 1 if score #cube.temp.reg.z PS.mem matches 1