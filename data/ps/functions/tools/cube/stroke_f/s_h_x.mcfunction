...
execute if score #tools.cube.s.temp PS.mem matches 1 if score #tools.cube.p.x PS.mem <= #tools.cube.whd.w PS.mem rotated as @s positioned ^ ^ ^1 run function ps:tools/cube/stroke_f/new_x
