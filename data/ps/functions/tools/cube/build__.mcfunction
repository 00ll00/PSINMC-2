...
execute if data storage ps:players storage.data.tools.cube_last{freemode:1b} as @e[tag=PS.tools.cube.stroke,tag=PS.players.belonging] at @s run function ps:tools/cube/stroke_f/call
