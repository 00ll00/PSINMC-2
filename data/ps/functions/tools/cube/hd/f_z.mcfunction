#as player
function ps:tools/com/getvz
function ps:tools/com/getvd

function ps:tools/cube/hd/getf

execute as @e[tag=PS.ctrl.gizmo.z,tag=PS.ctrl.cube,tag=PS.players.belonging] run data modify entity @s Pos set from entity 0-0110-5053-0-1 Pos

scoreboard players operation #cube.hdf.yz.x PS.mem = #cube.hdf.rx PS.mem
scoreboard players operation #cube.hdf.yz.y PS.mem = #cube.hdf.ry PS.mem
scoreboard players operation #cube.hdf.yz.z PS.mem = #cube.hdf.rz PS.mem
execute store result score #cube.hdf.xz.x PS.mem run scoreboard players operation #cube.hdf.yz.x PS.mem += #cube.hdf.vz.x PS.mem
execute store result score #cube.hdf.xz.y PS.mem run scoreboard players operation #cube.hdf.yz.y PS.mem += #cube.hdf.vz.y PS.mem
execute store result score #cube.hdf.xz.z PS.mem run scoreboard players operation #cube.hdf.yz.z PS.mem += #cube.hdf.vz.z PS.mem

scoreboard players operation #cube.hdf.xz.x PS.mem += #cube.hdf.vx.x PS.mem
scoreboard players operation #cube.hdf.xz.y PS.mem += #cube.hdf.vx.y PS.mem
scoreboard players operation #cube.hdf.xz.z PS.mem += #cube.hdf.vx.z PS.mem

execute store result score #cube.hdf.xyz.x PS.mem run scoreboard players operation #cube.hdf.yz.x PS.mem += #cube.hdf.vy.x PS.mem
execute store result score #cube.hdf.xyz.y PS.mem run scoreboard players operation #cube.hdf.yz.y PS.mem += #cube.hdf.vy.y PS.mem
execute store result score #cube.hdf.xyz.z PS.mem run scoreboard players operation #cube.hdf.yz.z PS.mem += #cube.hdf.vy.z PS.mem
