...
execute if score #tools.move PS.mem matches 0 at 0-0110-5053-0-1 unless entity @e[tag=PS.focus.old,tag=PS.players.belonging,dx=0,dy=0,dz=0] run function ps:tools/brush/draw